...
let showResult = queryResponse => {
	...
	timer = setInterval(()=>placeSunAndStartMoving(minutes, queryResponse.city.sunset, queryResponse.city.sunrise), 1000*60);
};

// 2 Aan de hand van een longitude en latitude gaan we de yahoo wheater API ophalen.
let getAPI = (lat, lon) => {
	// Eerst bouwen we onze url op
	const url = `http://api.openweathermap.org/data/2.5/forecast?lat=${lat}&lon=${lon}&appid=50be64c98faa6618426aab2dbefff454&units=metric&lang=nl&cnt=1`;
